...
SHOPIFY_COMMON_FIELDS = 'order_id order_num created_at note note_attributes customer total_discounts discount_codes discount_allocations name first_name last_name email '+\
